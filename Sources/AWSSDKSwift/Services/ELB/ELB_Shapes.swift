...
extension ELB {
    ...
    public struct Listener: AWSShape {
        ...
        public init(protocol: String, loadBalancerPort: Int32, instanceProtocol: String? = nil, sSLCertificateId: String? = nil, instancePort: Int32) {
    ...
    public struct CreateLoadBalancerPolicyInput: AWSShape {
        ...
        public init(loadBalancerName: String, policyAttributes: [PolicyAttribute]? = nil, policyTypeName: String, policyName: String) {
            self.loadBalancerName = loadBalancerName
    ...
    public struct HealthCheck: AWSShape {
        ...
        public init(timeout: Int32, healthyThreshold: Int32, unhealthyThreshold: Int32, target: String, interval: Int32) {
    ...
    public struct CreateAccessPointInput: AWSShape {
        ...
        public init(loadBalancerName: String, subnets: [String]? = nil, listeners: [Listener], scheme: String? = nil, securityGroups: [String]? = nil, availabilityZones: [String]? = nil, tags: [Tag]? = nil) {
            self.loadBalancerName = loadBalancerName
    ...
    public struct InstanceState: AWSShape {
        ...
        public init(instanceId: String? = nil, reasonCode: String? = nil, description: String? = nil, state: String? = nil) {
    ...
    public struct LoadBalancerAttributes: AWSShape {
        ...
        public init(connectionDraining: ConnectionDraining? = nil, connectionSettings: ConnectionSettings? = nil, accessLog: AccessLog? = nil, crossZoneLoadBalancing: CrossZoneLoadBalancing? = nil, additionalAttributes: [AdditionalAttribute]? = nil) {
    ...
    public struct CreateLBCookieStickinessPolicyInput: AWSShape {
        ...
        public init(cookieExpirationPeriod: Int64? = nil, policyName: String, loadBalancerName: String) {
    ...
    public struct DeleteLoadBalancerPolicyInput: AWSShape {
        ...
        public init(policyName: String, loadBalancerName: String) {
            self.policyName = policyName
            self.loadBalancerName = loadBalancerName
        }
    ...
    public struct AppCookieStickinessPolicy: AWSShape {
        ...
        public init(policyName: String? = nil, cookieName: String? = nil) {
            self.policyName = policyName
            self.cookieName = cookieName
        }
    ...
    public struct DescribeAccessPointsInput: AWSShape {
        ...
        public init(pageSize: Int32? = nil, loadBalancerNames: [String]? = nil, marker: String? = nil) {
            self.pageSize = pageSize
            self.loadBalancerNames = loadBalancerNames
            self.marker = marker
        }
    ...
    public struct PolicyAttributeTypeDescription: AWSShape {
        ...
        public init(description: String? = nil, defaultValue: String? = nil, attributeName: String? = nil, cardinality: String? = nil, attributeType: String? = nil) {
            self.description = description
    ...
    public struct AccessLog: AWSShape {
        ...
        public init(s3BucketName: String? = nil, emitInterval: Int32? = nil, enabled: Bool, s3BucketPrefix: String? = nil) {
    ...
    public struct LoadBalancerDescription: AWSShape {
        ...
        public init(loadBalancerName: String? = nil, healthCheck: HealthCheck? = nil, canonicalHostedZoneName: String? = nil, vPCId: String? = nil, instances: [Instance]? = nil, availabilityZones: [String]? = nil, securityGroups: [String]? = nil, subnets: [String]? = nil, dNSName: String? = nil, policies: Policies? = nil, listenerDescriptions: [ListenerDescription]? = nil, scheme: String? = nil, canonicalHostedZoneNameID: String? = nil, sourceSecurityGroup: SourceSecurityGroup? = nil, backendServerDescriptions: [BackendServerDescription]? = nil, createdTime: TimeStamp? = nil) {
            self.loadBalancerName = loadBalancerName
            self.healthCheck = healthCheck
